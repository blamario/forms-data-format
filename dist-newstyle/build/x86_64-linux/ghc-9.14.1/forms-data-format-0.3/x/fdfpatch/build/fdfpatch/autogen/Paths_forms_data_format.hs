...
{-|
Module      : Paths_forms_data_format
...
-- at runtime using the environment variable forms_data_format_bindir.
...
-- environment variable forms_data_format_libdir.
...
-- using the environment variable forms_data_format_dynlibdir.
...
-- runtime using the environment variable forms_data_format_datadir.
...
-- variable forms_data_format_libexedir.
...
-- using the environment variable forms_data_format_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/forms-data-format-0.3-inplace-fdfpatch"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/forms-data-format-0.3"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/forms-data-format-0.3"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "forms_data_format_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "forms_data_format_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "forms_data_format_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "forms_data_format_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "forms_data_format_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "forms_data_format_sysconfdir") (\_ -> return sysconfdir)
