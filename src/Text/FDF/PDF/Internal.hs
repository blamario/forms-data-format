...
-- | Internal PDF parsing and serialisation helpers for "Text.FDF.PDF".
--
-- This module is an implementation detail; callers should use
-- 'Text.FDF.PDF.parsePDF' and 'Text.FDF.PDF.fillPDF' instead.
module Text.FDF.PDF.Internal
  ( -- * PDF value types
    PDFValue (..)
  , XRefEntry (..)
  , XRef
  ...
  , Encryptor
  , ObjRef
    -- * High-level entry points used by "Text.FDF.PDF"
  , loadAcroFormFields
  , loadFieldObj
  , buildPathMap
  , collectUpdates
